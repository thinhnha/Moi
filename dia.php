...
<body onload="showSlides()">
    ...
    <div class="product-filters">
        <a href="dia.php?type=0" class="ps5">PS5</a>
        <a href="dia.php?type=1" class="ps4">PS4</a>
        <a href="dia.php?type=2" class="Nintendo_Switch">Nintendo Switch</a>
        <a href="dia.php?type=3" class="Xbox_One">Xbox One</a>
        <a href="dia.php" class="all">Tất cả</a> <!-- Lọc lại tất cả sản phẩm -->
    </div>
